import 'package:base_setup/data/viewmodels/mt4.viewmodel.dart';
...
class MT4Screen extends StatefulWidget {
  ...
  @override
  State<MT4Screen> createState() => _MT4Screen();
}

class _MT4Screen extends State<MT4Screen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return MT4ViewModel.buildWithProvider(
        builder: (_, __) {
          return _Body();
        },
...
class _Body extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    MT4ViewModel model = Provider.of<MT4ViewModel>(context);
